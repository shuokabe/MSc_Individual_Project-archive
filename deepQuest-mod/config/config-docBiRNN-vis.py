def load_parameters():
    ...
    INPUTS_IDS_DATASET = ['source_text', 'target_text', 'visual_feature']     # Corresponding inputs of the dataset
    #OUTPUTS_IDS_DATASET_FULL = ['target_text', 'word_qe', 'sent_hter']                   # Corresponding outputs of the dataset
    OUTPUTS_IDS_DATASET = ['doc_qe']
    INPUTS_IDS_MODEL = ['source_text', 'target_text', 'visual_feature']       # Corresponding inputs of the built model
    #OUTPUTS_IDS_MODEL_FULL = ['target_text','word_qe', 'sent_hter']                     # Corresponding outputs of the built model
    OUTPUTS_IDS_MODEL = ['doc_qe']
    WORD_QE_CLASSES = 5
    SECOND_DIM_SIZE = 50 #43
    OUT_ACTIVATION='sigmoid'
    PRED_SCORE = 'bleu' #'mqm'
    VISUAL_FEATURE = 'vis' # Visual features
    LEN_VISUAL_FEATURE = 4096
    ...
    # Model parameters
    # Perictor+Estimator
    MODEL_TYPE = 'EncDocVis'                 # Model to train. See model_zoo() for the supported architectures
    ...
    # Exclusive to visual features
    VISUAL_FEATURE_METHOD = 'concatenation'                #('time-step', 'concatenation', 'add-embedding', 'state-init') supported
    ONE_SIDE = False
