def load_parameters():
    ...
    # Input data params
    TASK_NAME = 'sent-level'                           # Task name
    ...
    # Model parameters
    # Perictor+Estimator
    MODEL_TYPE = 'EncSentVis'                 # Model to train. See model_zoo() for the supported architectures
    ...
    VISUAL_FEATURE_METHOD = 'concatenation'                #('time-step', 'concatenation', 'add-embedding') supported
    ONE_SIDE = False
